...
import type { WithId, Business } from '@/types/firestore';
...
export default function SignupPage() {
  ...
  const [businesses, setBusinesses] = useState<WithId<Business>[]>([]);
  ...
  useEffect(() => {
    ...
    getDocs(collection(db, "businesses"))
      .then((snapshot) => {
        const list = snapshot.docs.map((d) => ({ id: d.id, ...d.data() })) as WithId<Business>[];
        setBusinesses(list);
      })
