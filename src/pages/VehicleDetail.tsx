...
import type { WithId, Vehicle, Project } from "@/types/firestore";
...
export default function VehicleDetailPage() {
  ...
  const [vehicle, setVehicle] = useState<WithId<Vehicle> | null>(null);
          ...
          <div className="rounded-xl border border-[#E0E0E0] bg-white shadow-sm p-6 hover:shadow-md transition-shadow duration-200">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-[#37352F]">
                  {(vehicle as { createdByEmployeeAcc?: string }).createdByEmployeeAcc || "-"}
                </p>
              </div>
